...
class FinetuneConfig:
    ...
    """Path(s) to dataset root directories. Multiple paths will be mixed equally during training."""
    ...
    """Video decoding backend. Options: 'torchcodec' (default), 'torchvision_av' (faster)."""
